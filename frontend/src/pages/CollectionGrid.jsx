    ...
    <>
      ...
      <div className="photo-grid w-full h-screen bg-black grid grid-cols-4 items-center justify-items-center text-white">
        <div className="photo-grid-item">
          <div className="photo-grid-media w-80 aspect-[9/16] bg-pink-400 overflow-hidden">
            <img
              src={adm}
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-80 aspect-[9/16] bg-pink-500 overflow-hidden">
            <img
              src={image004}
              className="w-full h-full object-cover hover:scale-105 transition-all duration-350 cursor-pointer"
            />
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-80 aspect-[9/16] bg-pink-600 overflow-hidden">
            <img
              src={creativeAnimals}
              className="w-full h-full object-cover hover:scale-105 transition-all duration-350 cursor-pointer"
            />
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-80 aspect-[9/16] bg-pink-700 overflow-hidden">
            <img
              src={daman1}
              className="w-full h-full object-cover hover:scale-105 transition-all duration-350 cursor-pointer"
            />
