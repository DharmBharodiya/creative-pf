        ...
        <div className="w-220 h-auto flex flex-col justify-center items-start pt-10">
          ...
          <div className="flex justify-start items-center w-full gap-6 tracking-tight">
            <h1 className="font-sloop text-8xl">
              W<span className="font-times text-6xl tracking-tight">ork</span>
            </h1>
            <h1 className="font-sloop text-8xl">
              E
          ...
          {/*  */}
          <div className="text-white font-quicksand text-sm w-[90%]">
            <p className="mb-6">
          ...
          {/* third part */}
          <div>
            <div className="font-quicksand tracking-tighter text-white grid grid-cols-3 grid-rows-1 gap-4">
              <div className="border-r-4 border-white/40 pr-4">
                <h1 className="font-semibold mb-3 text-nowrap">
                  ART | DESIGN | GRAPHICS
                </h1>
                <p className="text-sm">
              ...
              {/* <div className=""></div> */}
              <div className="border-r-4 border-white/40 pr-4">
                <h1 className="font-semibold mb-3">PHOTOGRAPHY</h1>
                <p className="text-sm">
              ...
              {/* <div className=""></div> */}
              <div>
                <h1 className="font-semibold mb-3">CINEMATOGRAPHY</h1>
