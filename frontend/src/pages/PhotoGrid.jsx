    ...
    <>
      ...
      <div className="photo-grid w-full h-screen bg-black grid grid-cols-2 lg:grid-cols-4 items-center justify-items-center text-white">
        <div className="photo-grid-item">
          <div className="photo-grid-media w-60 lg:w-80 lg:h-auto aspect-4/5 bg-pink-400 overflow-hidden">
            <img
              src={makingoffairy}
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-60 lg:w-80 lg:h-auto aspect-4/5 bg-pink-500 overflow-hidden">
            <img
              src={trainfeet}
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-60 lg:w-80 lg:h-auto aspect-4/5 bg-pink-600 overflow-hidden">
            <img
              src={eyeSketch}
              className="w-full h-full object-cover lg:hover:scale-105 transition-all duration-350 cursor-pointer"
            />
        ...
        <div className="photo-grid-item">
          <div className="photo-grid-media w-60 lg:w-80 lg:h-auto aspect-4/5 bg-pink-700 overflow-hidden">
            <img
              src={balloons}
              className="w-full h-full object-cover lg:hover:scale-105 transition-all duration-350 cursor-pointer"
            />
