      ...
      <div className="w-full h-screen overflow-hidden bg-black flex flex-col selection:bg-red-800 selection:text-white">
        ...
        <div className="w-full flex-1 min-h-0 bg-red-500 mt-8 grid grid-cols-3">
          <div className="w-full min-w-0 min-h-0 h-full bg-amber-500 overflow-hidden">
            <img
              src={panic}
              className="block object-cover w-full h-full hover:scale-105 cursor-pointer duration-150 transition-all"
            />
          </div>
          <div className="w-full min-w-0 min-h-0 h-full bg-green-800 grid grid-cols-3 grid-rows-3">
            ...
            <div className="bg-red-800 w-full h-full overflow-hidden">
              <img
                src={euphoria}
                className="block scale-102 object-cover object-[50%_10%] w-full h-full hover:scale-105 cursor-pointer duration-150 transition-all"
              />
            </div>
            ...
            <div className="bg-black w-full h-full col-span-2 overflow-hidden">
              <img
                src={invite}
                className="block object-cover w-full h-full object-[50%_90%] hover:scale-105 cursor-pointer duration-150 transition-all"
              />
            </div>
