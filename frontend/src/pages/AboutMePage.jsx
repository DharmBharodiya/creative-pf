  ...
  return (
    <>
      ...
      <div className="w-full h-screen bg-black flex justify-center items-center selection:bg-red-800 selection:text-white">
        <div className="w-[93%] h-full grid grid-cols-1 lg:grid-cols-[2fr_3fr] justify-center">
          <div className="flex ml-15 flex-col justify-center items-start text-red-800">
            <div className="flex gap-3 justify-start">
              <h1 className="font-sloop text-6xl lg:text-8xl">
                A<span className="font-times text-4xl lg:text-6xl">bout</span>
              </h1>
              <h1 className="font-sloop text-6xl lg:text-8xl">
                M<span className="font-times text-4xl lg:text-6xl">e</span>
              </h1>
            </div>
            <div className="w-[80%] lg:w-[60%] text-white text-xs lg:text-sm font-quicksand">
              <p>
          ...
          <div className="w-full h-full flex flex-col lg:justify-center items-center">
            <div className="flex bg-blue-600 w-fit">
              ...
              <div className="w-56 lg:w-96 aspect-4/5 bg-red-900 flex justify-center items-center">
                <img
                  src={sunsetImage}
                  className="w-40 lg:w-80 aspect-4/5 object-cover hover:w-56 hover:aspect-[4/5] lg:hover:w-96 lg:hover:h-120 transition-all duration-400 cursor-pointer"
                />
              </div>
            </div>
            <div>
              <p className="text-white w-[92%] font-quicksand text-xs lg:text-sm mx-6 lg:ml-12 mt-2 tracking-tight">
